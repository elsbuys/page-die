                    ...
                    <div className='flex flex-col gap-2 py-2'>
                        {FORM_FIELDS.map((field) => (
                            <div key={field.name}>
                                ...
                                <input name={field.name} type={field.type} value={formData[field.name]} onChange={handleInputChange} required className='h-12.5 w-full rounded-[10px] border-2 border-[#d4dbe3] px-3 py-1.5' />
                            </div>
                        ))}
                        ...
                        <div className='flex items-center gap-2 pt-2'>
                            <input id='termsAccepted' type='checkbox' checked={isTermsAccepted} onChange={(e) => setIsTermsAccepted(e.target.checked)} required className='cursor-pointer' />
